...
// Zone de confidentialité : supprime les points à moins de `radiusKm` du départ/arrivée
function applyPrivacyZone(points, radiusKm = 0.5) {
  ...
  return trimmed.length >= 2 ? trimmed : points; // si trop court, garder le tracé complet
}
...
async function shareCurrentTrail(run) {
  ...
  // Zone de confidentialité : masque les 500 premiers et derniers mètres
