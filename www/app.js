...
document.getElementById("auth-toggle-btn")?.addEventListener("click", () => {
  ...
  document.getElementById("auth-submit").textContent = isSignup ? t("auth_signup") : t("auth_login");
  document.getElementById("auth-toggle-text").textContent = isSignup ? t("auth_have_account") : t("auth_no_account");
  document.getElementById("auth-toggle-btn").textContent = isSignup ? t("auth_login") : t("auth_signup");
...
document.getElementById("auth-form")?.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    if (result.error) {
      ...
      btn.disabled = false;
      btn.textContent = authMode === "signup" ? t("auth_signup") : t("auth_login");
      return;
    }
...
const TRANSLATIONS = {
  fr: {
    ...
    // --- Auth ---
    auth_companion: "Votre compagnon de mushing",
    auth_pseudo_label: "Pseudo (ton nom sur MushTrack)",
    auth_email: "Email",
    ...
    nav_tips: "Conseils",
    // --- Dashboard ---
    dash_active_season: "SAISON ACTIVE",
    dash_days_left: "jours restants",
    dash_global_prep: "PRÉPARATION GLOBALE",
    dash_current_phase: "Phase actuelle",
    dash_start_session: "▶ DÉMARRER LA SÉANCE",
    dash_team_tile: "ATTELAGE",
    dash_avg_energy: "Énergie moy.",
    dash_conditions_tile: "CONDITIONS",
    dash_this_week_tile: "CETTE SEMAINE",
    dash_streak_tile: "SÉRIE",
    dash_coach_title: "COACH MUSHTRACK",
    dash_full_analysis: "Voir l'analyse complète",
    dash_ask_question: "Poser une question",
    dash_our_reco: "NOTRE RECOMMANDATION",
    dash_perfect_progress: "Parfait pour progresser ! ✨",
    dash_progression: "PROGRESSION",
    dash_mission_week: "MISSION SEMAINE",
    dash_runs_label: "Sorties",
    dash_progress_label: "Progression",
    dash_race_goal_label: "Objectif race",
    dash_partners: "Partenaires",
    dash_planned_load: "Charge prévue",
    dash_daily_goal: "🏃 OBJECTIF DU JOUR",
    dash_distance_label: "Distance",
    dash_estimated_duration: "Durée estimée",
    dash_intensity_label: "Intensité",
    dash_mission_title: "Mission",
    // --- GPS Screen ---
    gps_session: "Sortie GPS",
    gps_searching: "Recherche GPS…",
    gps_distance: "Distance",
    gps_duration: "Durée",
    gps_avg: "Moy.",
    gps_speed: "Vitesse",
    gps_map_background: "Fond de carte",
    gps_units_label: "Unités GPS",
    gps_finish: "Terminer",
    gps_live_share: "Partager en direct",
    gps_live_active: "Suivi en direct actif",
    gps_share: "Partager",
    gps_stop: "Stop",
    gps_engin: "Engin",
    gps_team_today: "Attelage du jour",
    gps_edit: "Modifier ✏️",
    gps_run_summary: "Bilan de la sortie",
    gps_auto_notes: "Auto + notes",
    gps_detected_type: "Type détecté",
    gps_auto_weather: "Météo auto",
    gps_energy: "Énergie",
    gps_energy_5: "5 - très bonne",
    gps_energy_4: "4 - bonne",
    gps_energy_3: "3 - moyenne",
    gps_energy_2: "2 - basse",
    gps_energy_1: "1 - mauvaise",
    gps_recovery: "Récupération",
    gps_recovery_excellent: "Excellente",
    gps_recovery_good: "Bonne",
    gps_recovery_watch: "À surveiller",
    gps_recovery_hard: "Difficile",
    gps_paw_check: "Pattes contrôlées",
    gps_hydration: "Hydratation OK",
    gps_notes: "Notes",
    gps_save_run: "Enregistrer la sortie",
    // --- Run detail ---
    rd_distance: "Distance",
    rd_duration: "Durée",
    rd_avg_speed: "Vitesse moy.",
    rd_dogs: "Chiens",
    rd_equipment: "Engin",
    rd_weather: "Météo",
    rd_team_energy: "Énergie équipe",
    rd_recovery: "Récupération",
    rd_notes: "Notes",
    // --- Dogs ---
    dogs_notebook: "Carnet",
    dogs_title: "Chiens",
    dogs_add_photo: "📷 Ajouter une photo",
    dogs_name: "Nom",
    dogs_position: "Poste",
    dogs_birthdate: "Date de naissance",
    dogs_weight: "Poids",
    dogs_harness: "Harnais",
    dogs_vet: "Suivi veto",
    dogs_health_note: "Point de vigilance",
    dogs_note: "Note",
    dogs_add_btn: "Ajouter",
    dogs_team_selection: "Sélection attelage",
    dogs_tap_to_toggle: "Touche pour ajouter/enlever",
    dogs_ration: "Ration alimentaire",
    dogs_calculate: "Calculer ▾",
    dogs_dog_weight: "Poids du chien (kg)",
    dogs_km_week: "Km cette semaine",
    dogs_food_density: "Densité aliment (kcal/100g)",
    dogs_calc_btn: "Calculer",
    dogs_edit_btn: "Editer",
    ...
    race_loading: "Chargement…",
    // --- Network ---
    net_title: "Réseau",
    net_mushers_connected: "Mushers connecté·e·s",
    net_share_run: "Partage ta dernière sortie",
    net_add_photo: "📷 Ajouter une photo",
    net_share_network: "🐕 Partager au réseau",
    net_feed_tab: "Fil",
    net_challenges_tab: "Défis",
    net_clubs_tab: "Clubs",
    net_map_tab: "Carte",
    net_create_club: "＋ Créer un club",
    net_join_club: "Rejoindre",
    net_new_club: "Nouveau club",
    net_club_confirm: "Créer",
    net_appear_map: "Apparaître sur la carte (région seulement)",
    net_approx_position: "Position approchée — seule ta région est visible, pas ton adresse exacte.",
    // --- Settings ---
    settings_season_goal: "Objectif de la saison",
    settings_objectives: "Objectifs",
    settings_season: "Saison",
    settings_language: "Langue",
    settings_season_mode: "Mode saison",
    settings_summer: "Eté",
    settings_winter: "Hiver",
    settings_profile: "Profil MushTrack",
    settings_pseudo: "Pseudo",
    settings_region: "Region",
    settings_level: "Niveau",
    settings_disciplines: "Disciplines",
    settings_goal_km: "Objectif km",
    settings_goal_date: "Date limite",
    settings_quick_presets: "Présets rapides",
    settings_race_name: "Nom de la course objectif",
    settings_race_date: "Date de la course",
    settings_race_type: "Type de course",
    settings_race_km: "Distance de course (km)",
    settings_update: "Mettre a jour",
    settings_export_data: "Export données",
    settings_export_pdf: "📄 Rapport PDF (saison complète)",
    settings_export_csv: "📊 Export CSV (sorties — pour entraîneur)",
    settings_personal_data: "Données personnelles",
    settings_rgpd: "RGPD",
    settings_delete_warning: "Supprime définitivement toutes tes données : sorties, chiens, profil et données Supabase. Cette action est irréversible.",
    settings_delete_btn: "🗑️ Supprimer mon compte et mes données",
    settings_delete_confirm_q: "⚠️ Confirmes-tu la suppression définitive de toutes tes données ?",
    settings_delete_yes: "Oui, supprimer",
    settings_public_profile: "Profil public",
    settings_sponsors: "Partage sponsors",
    settings_slug_label: "Ton slug (identifiant URL)",
    settings_publish: "🌐 Publier mon profil",
    settings_published: "✅ Profil publié !",
    settings_copy_link: "📋 Copier le lien",
    // --- Coach ---
    coach_smart_training: "Entraînement intelligent",
    coach_title: "Coach",
    coach_analyze: "Analyser",
    coach_question_placeholder: "Question précise (optionnel) — ex: Mon chien récupère mal, que faire ?",
    coach_ia: "Coach MushTrack IA",
    coach_personalized: "Analyse personnalisée",
    // --- Agenda ---
    agenda_personal_planning: "Planning personnel",
    agenda_title: "Agenda",
    agenda_add: "+ Ajouter",
    agenda_event_title: "Titre",
    agenda_date: "Date",
    agenda_category: "Catégorie",
    agenda_notes: "Notes",
    // --- Vous ---
    vous_my_space: "Mon espace",
    vous_title: "Vous",
    ...
    plan_long_run: "Jour de sortie 🐕",
    plan_endurance: "Jour de sortie 🐕",
    plan_intervals: "Jour de sortie 🐕",
    plan_recov_note: "Tes chiens semblent avoir besoin de repos — un jour de pause peut faire du bien.",
    plan_next_km: "Si tu en as envie, environ {n} km serait bien selon ta progression. C'est une suggestion, fais selon toi et tes chiens.",
    // --- Alertes chiens ---
    ...
    // --- Sessions types ---
    session_endurance: "Jour de sortie 🐕", session_long: "Jour de sortie 🐕", session_sprint: "Jour de sortie 🐕",
    session_recup: "Jour de repos 😴", session_rest: "Jour de repos 😴", session_technique: "Jour de sortie 🐕",
    session_endurance_desc: "Selon ton envie et celle de tes chiens",
    session_long_desc: "Selon ton envie et celle de tes chiens",
    session_sprint_desc: "Selon ton envie et celle de tes chiens",
    session_recup_desc: "Allure douce, pattes et harnais contrôlés",
    session_rest_desc: "Détente, câlins, jeu libre",
    ...
    analytics_team_health: "Sante team",
    analytics_training_decision: "Decision entrainement",
    analytics_dog_load: "Charge chiens",
    analytics_last_7_days: "7 derniers jours",
    analytics_alerts: "Alertes",
    analytics_coach: "Coach",
    // --- Advice ---
    advice_health_perf: "Santé & performance",
    advice_title: "Conseils",
    advice_important: "🚨 Important",
    advice_warning_title: "Signaux d'alerte à ne jamais ignorer",
    advice_all: "📋 Tous",
    // --- Common ---
    btn_back: "Retour",
    btn_add: "Ajouter",
    ...
    race_none_found: "Aucune course trouvée. Essaie une région plus large comme Europe, Suède, Norvège ou Amundsen.",
  ...
  en: {
    ...
    // Auth
    auth_companion: "Your mushing companion",
    auth_pseudo_label: "Username (your name on MushTrack)",
    auth_email: "Email",
    ...
    nav_tips: "Tips",
    // Dashboard
    dash_active_season: "ACTIVE SEASON",
    dash_days_left: "days left",
    dash_global_prep: "GLOBAL PREPARATION",
    dash_current_phase: "Current phase",
    dash_start_session: "▶ START SESSION",
    dash_team_tile: "TEAM",
    dash_avg_energy: "Avg. energy",
    dash_conditions_tile: "CONDITIONS",
    dash_this_week_tile: "THIS WEEK",
    dash_streak_tile: "STREAK",
    dash_coach_title: "COACH MUSHTRACK",
    dash_full_analysis: "View full analysis",
    dash_ask_question: "Ask a question",
    dash_our_reco: "OUR RECOMMENDATION",
    dash_perfect_progress: "Perfect for progress! ✨",
    dash_progression: "PROGRESSION",
    dash_mission_week: "WEEKLY MISSION",
    dash_runs_label: "Runs",
    dash_progress_label: "Progress",
    dash_race_goal_label: "Race goal",
    dash_partners: "Partners",
    dash_planned_load: "Planned load",
    dash_daily_goal: "🏃 TODAY'S GOAL",
    dash_distance_label: "Distance",
    dash_estimated_duration: "Estimated duration",
    dash_intensity_label: "Intensity",
    dash_mission_title: "Mission",
    // GPS
    gps_session: "GPS Run",
    gps_searching: "Searching GPS…",
    gps_distance: "Distance",
    gps_duration: "Duration",
    gps_avg: "Avg.",
    gps_speed: "Speed",
    gps_map_background: "Map background",
    gps_units_label: "GPS Units",
    gps_finish: "Finish",
    gps_live_share: "Live share",
    gps_live_active: "Live tracking active",
    gps_share: "Share",
    gps_stop: "Stop",
    gps_engin: "Equipment",
    gps_team_today: "Today's team",
    gps_edit: "Edit ✏️",
    gps_run_summary: "Run summary",
    gps_auto_notes: "Auto + notes",
    gps_detected_type: "Detected type",
    gps_auto_weather: "Auto weather",
    gps_energy: "Energy",
    gps_energy_5: "5 - very good",
    gps_energy_4: "4 - good",
    gps_energy_3: "3 - average",
    gps_energy_2: "2 - low",
    gps_energy_1: "1 - poor",
    gps_recovery: "Recovery",
    gps_recovery_excellent: "Excellent",
    gps_recovery_good: "Good",
    gps_recovery_watch: "Monitor",
    gps_recovery_hard: "Difficult",
    gps_paw_check: "Paws checked",
    gps_hydration: "Hydration OK",
    gps_notes: "Notes",
    gps_save_run: "Save run",
    // Run detail
    rd_distance: "Distance",
    rd_duration: "Duration",
    rd_avg_speed: "Avg. speed",
    rd_dogs: "Dogs",
    rd_equipment: "Equipment",
    rd_weather: "Weather",
    rd_team_energy: "Team energy",
    rd_recovery: "Recovery",
    rd_notes: "Notes",
    // Dogs
    dogs_notebook: "Notebook",
    dogs_title: "Dogs",
    dogs_add_photo: "📷 Add a photo",
    dogs_name: "Name",
    dogs_position: "Position",
    dogs_birthdate: "Date of birth",
    dogs_weight: "Weight",
    dogs_harness: "Harness",
    dogs_vet: "Vet tracking",
    dogs_health_note: "Health note",
    dogs_note: "Note",
    dogs_add_btn: "Add",
    dogs_team_selection: "Team selection",
    dogs_tap_to_toggle: "Tap to add/remove",
    dogs_ration: "Food ration",
    dogs_calculate: "Calculate ▾",
    dogs_dog_weight: "Dog weight (kg)",
    dogs_km_week: "Km this week",
    dogs_food_density: "Food density (kcal/100g)",
    dogs_calc_btn: "Calculate",
    dogs_edit_btn: "Edit",
    dogs_delete_btn: "Delete",
    dogs_no_dogs: "No dogs registered.",
    // Race
    race_competition: "Competition mode",
    race_title: "Race",
    race_missing: "Report a missing race",
    race_leaderboard: "Monthly ranking",
    race_loading: "Loading…",
    // Network
    net_title: "Network",
    net_mushers_connected: "Connected mushers",
    net_share_run: "Share your last run",
    net_add_photo: "📷 Add a photo",
    net_share_network: "🐕 Share to network",
    net_feed_tab: "Feed",
    net_challenges_tab: "Challenges",
    net_clubs_tab: "Clubs",
    net_map_tab: "Map",
    net_create_club: "＋ Create a club",
    net_join_club: "Join",
    net_new_club: "New club",
    net_club_confirm: "Create",
    net_appear_map: "Appear on the map (region only)",
    net_approx_position: "Approximate position — only your region is visible, not your exact address.",
    // Settings
    settings_season_goal: "Season goal",
    settings_objectives: "Objectives",
    settings_season: "Season",
    settings_language: "Language",
    settings_season_mode: "Season mode",
    settings_summer: "Summer",
    settings_winter: "Winter",
    settings_profile: "MushTrack Profile",
    settings_pseudo: "Username",
    settings_region: "Region",
    settings_level: "Level",
    settings_disciplines: "Disciplines",
    settings_goal_km: "Goal km",
    settings_goal_date: "Deadline",
    settings_quick_presets: "Quick presets",
    settings_race_name: "Target race name",
    settings_race_date: "Race date",
    settings_race_type: "Race type",
    settings_race_km: "Race distance (km)",
    settings_update: "Update",
    settings_export_data: "Export data",
    settings_export_pdf: "📄 PDF Report (full season)",
    settings_export_csv: "📊 CSV Export (runs — for coach)",
    settings_personal_data: "Personal data",
    settings_rgpd: "GDPR",
    settings_delete_warning: "Permanently deletes all your data: runs, dogs, profile and Supabase data. This action is irreversible.",
    settings_delete_btn: "🗑️ Delete my account and data",
    settings_delete_confirm_q: "⚠️ Do you confirm permanent deletion of all your data?",
    settings_delete_yes: "Yes, delete",
    settings_public_profile: "Public profile",
    settings_sponsors: "Share with sponsors",
    settings_slug_label: "Your slug (URL identifier)",
    settings_publish: "🌐 Publish my profile",
    settings_published: "✅ Profile published!",
    settings_copy_link: "📋 Copy link",
    // Coach
    coach_smart_training: "Smart training",
    coach_title: "Coach",
    coach_analyze: "Analyze",
    coach_question_placeholder: "Specific question (optional) — e.g.: My dog recovers poorly, what to do?",
    coach_ia: "Coach MushTrack AI",
    coach_personalized: "Personalized analysis",
    // Agenda
    agenda_personal_planning: "Personal planning",
    agenda_title: "Agenda",
    agenda_add: "+ Add",
    ...
    plan_long_run: "Run day 🐕",
    plan_endurance: "Run day 🐕",
    plan_intervals: "Run day 🐕",
    plan_recov_note: "Your dogs may need a rest day — a break can do a lot of good.",
    plan_next_km: "If you feel like it, around {n} km would be great. Just a suggestion — you know your dogs best.",
    // Dog alerts
    ...
    // Session types
    session_endurance: "Run day 🐕", session_long: "Run day 🐕", session_sprint: "Run day 🐕",
    session_recup: "Rest day 😴", session_rest: "Rest day 😴", session_technique: "Run day 🐕",
    session_endurance_desc: "Go if you and your dogs feel like it",
    session_long_desc: "Go if you and your dogs feel like it",
    session_sprint_desc: "Go if you and your dogs feel like it",
    session_recup_desc: "Easy pace, paws and harness check",
    session_rest_desc: "Relax, cuddles, free play",
    ...
    analytics_stats: "Stats",
    analytics_team_health: "Team health",
    analytics_training_decision: "Training decision",
    analytics_dog_load: "Dog load",
    analytics_last_7_days: "Last 7 days",
    analytics_alerts: "Alerts",
    analytics_coach: "Coach",
    // Advice
    advice_health_perf: "Health & performance",
    advice_title: "Tips",
    advice_important: "🚨 Important",
    advice_warning_title: "Warning signs never to ignore",
    advice_all: "📋 All",
    // Common
    btn_back: "Back",
    btn_add: "Add",
    ...
    race_none_found: "No race found. Try a broader region like Europe, Sweden, Norway or Amundsen.",
  ...
  de: {
    ...
    // Auth
    auth_companion: "Ihr Mushing-Begleiter",
    auth_pseudo_label: "Benutzername (dein Name auf MushTrack)",
    auth_email: "E-Mail",
    ...
    nav_tips: "Tipps",
    // Dashboard
    dash_active_season: "AKTIVE SAISON",
    dash_days_left: "Tage verbleibend",
    dash_global_prep: "GLOBALE VORBEREITUNG",
    dash_current_phase: "Aktuelle Phase",
    dash_start_session: "▶ TRAINING STARTEN",
    dash_team_tile: "TEAM",
    dash_avg_energy: "Durchschn. Energie",
    dash_conditions_tile: "BEDINGUNGEN",
    dash_this_week_tile: "DIESE WOCHE",
    dash_streak_tile: "SERIE",
    dash_coach_title: "COACH MUSHTRACK",
    dash_full_analysis: "Vollständige Analyse",
    dash_ask_question: "Frage stellen",
    dash_our_reco: "UNSERE EMPFEHLUNG",
    dash_perfect_progress: "Perfekt zum Verbessern! ✨",
    dash_progression: "FORTSCHRITT",
    dash_mission_week: "WOCHENMISSION",
    dash_runs_label: "Ausfahrten",
    dash_progress_label: "Fortschritt",
    dash_race_goal_label: "Rennziel",
    dash_partners: "Partner",
    dash_planned_load: "Geplante Last",
    dash_daily_goal: "🏃 TAGESZIEL",
    dash_distance_label: "Distanz",
    dash_estimated_duration: "Geschätzte Dauer",
    dash_intensity_label: "Intensität",
    dash_mission_title: "Mission",
    // GPS
    gps_session: "GPS-Ausfahrt",
    gps_searching: "GPS suchen…",
    gps_distance: "Distanz",
    gps_duration: "Dauer",
    gps_avg: "Durchschn.",
    gps_speed: "Geschwindigkeit",
    gps_map_background: "Kartenhintergrund",
    gps_units_label: "GPS-Einheiten",
    gps_finish: "Beenden",
    gps_live_share: "Live teilen",
    gps_live_active: "Live-Tracking aktiv",
    gps_share: "Teilen",
    gps_stop: "Stop",
    gps_engin: "Gerät",
    gps_team_today: "Heutiges Team",
    gps_edit: "Bearbeiten ✏️",
    gps_run_summary: "Ausfahrtzusammenfassung",
    gps_auto_notes: "Auto + Notizen",
    gps_detected_type: "Erkannter Typ",
    gps_auto_weather: "Automatisches Wetter",
    gps_energy: "Energie",
    gps_energy_5: "5 - sehr gut",
    gps_energy_4: "4 - gut",
    gps_energy_3: "3 - mittel",
    gps_energy_2: "2 - niedrig",
    gps_energy_1: "1 - schlecht",
    gps_recovery: "Erholung",
    gps_recovery_excellent: "Ausgezeichnet",
    gps_recovery_good: "Gut",
    gps_recovery_watch: "Beobachten",
    gps_recovery_hard: "Schwierig",
    gps_paw_check: "Pfoten kontrolliert",
    gps_hydration: "Hydration OK",
    gps_notes: "Notizen",
    gps_save_run: "Ausfahrt speichern",
    // Run detail
    rd_distance: "Distanz",
    rd_duration: "Dauer",
    rd_avg_speed: "Durchschn. Geschw.",
    rd_dogs: "Hunde",
    rd_equipment: "Gerät",
    rd_weather: "Wetter",
    rd_team_energy: "Teamenergie",
    rd_recovery: "Erholung",
    rd_notes: "Notizen",
    // Dogs
    dogs_notebook: "Notizbuch",
    dogs_title: "Hunde",
    dogs_add_photo: "📷 Foto hinzufügen",
    dogs_name: "Name",
    dogs_position: "Position",
    dogs_birthdate: "Geburtsdatum",
    dogs_weight: "Gewicht",
    dogs_harness: "Geschirr",
    dogs_vet: "Tierarzt",
    dogs_health_note: "Gesundheitshinweis",
    dogs_note: "Notiz",
    dogs_add_btn: "Hinzufügen",
    dogs_team_selection: "Teamauswahl",
    dogs_tap_to_toggle: "Tippen zum Hinzufügen/Entfernen",
    dogs_ration: "Futterration",
    dogs_calculate: "Berechnen ▾",
    dogs_dog_weight: "Hundegewicht (kg)",
    dogs_km_week: "Km diese Woche",
    dogs_food_density: "Futterdichte (kcal/100g)",
    dogs_calc_btn: "Berechnen",
    dogs_edit_btn: "Bearbeiten",
    dogs_delete_btn: "Löschen",
    dogs_no_dogs: "Keine Hunde registriert.",
    // Race
    race_competition: "Wettkampfmodus",
    race_title: "Rennen",
    race_missing: "Fehlendes Rennen melden",
    race_leaderboard: "Monatsranking",
    race_loading: "Laden…",
    // Network
    net_title: "Netzwerk",
    net_mushers_connected: "Verbundene Musher",
    net_share_run: "Letzte Ausfahrt teilen",
    net_add_photo: "📷 Foto hinzufügen",
    net_share_network: "🐕 Im Netzwerk teilen",
    net_feed_tab: "Feed",
    net_challenges_tab: "Herausforderungen",
    net_clubs_tab: "Clubs",
    net_map_tab: "Karte",
    net_create_club: "＋ Club erstellen",
    net_join_club: "Beitreten",
    net_new_club: "Neuer Club",
    net_club_confirm: "Erstellen",
    net_appear_map: "Auf der Karte erscheinen (nur Region)",
    net_approx_position: "Ungefähre Position — nur deine Region ist sichtbar, nicht deine genaue Adresse.",
    // Settings
    settings_season_goal: "Saisonziel",
    settings_objectives: "Ziele",
    settings_season: "Saison",
    settings_language: "Sprache",
    settings_season_mode: "Saisonmodus",
    settings_summer: "Sommer",
    settings_winter: "Winter",
    settings_profile: "MushTrack Profil",
    settings_pseudo: "Benutzername",
    settings_region: "Region",
    settings_level: "Niveau",
    settings_disciplines: "Disziplinen",
    settings_goal_km: "Ziel km",
    settings_goal_date: "Frist",
    settings_quick_presets: "Schnellvorlagen",
    settings_race_name: "Zielrennenname",
    settings_race_date: "Renndatum",
    settings_race_type: "Renntyp",
    settings_race_km: "Renndistanz (km)",
    settings_update: "Aktualisieren",
    settings_export_data: "Daten exportieren",
    settings_export_pdf: "📄 PDF-Bericht (gesamte Saison)",
    settings_export_csv: "📊 CSV-Export (Ausfahrten — für Trainer)",
    settings_personal_data: "Persönliche Daten",
    settings_rgpd: "DSGVO",
    settings_delete_warning: "Löscht dauerhaft alle deine Daten: Ausfahrten, Hunde, Profil und Supabase-Daten. Diese Aktion ist unumkehrbar.",
    settings_delete_btn: "🗑️ Mein Konto und Daten löschen",
    settings_delete_confirm_q: "⚠️ Bestätigst du die dauerhafte Löschung aller deiner Daten?",
    settings_delete_yes: "Ja, löschen",
    settings_public_profile: "Öffentliches Profil",
    settings_sponsors: "Sponsoren teilen",
    settings_slug_label: "Dein Slug (URL-Kennung)",
    settings_publish: "🌐 Profil veröffentlichen",
    settings_published: "✅ Profil veröffentlicht!",
    settings_copy_link: "📋 Link kopieren",
    // Coach
    coach_smart_training: "Intelligentes Training",
    coach_title: "Coach",
    coach_analyze: "Analysieren",
    coach_question_placeholder: "Spezifische Frage (optional) — z.B.: Mein Hund erholt sich schlecht, was tun?",
    coach_ia: "Coach MushTrack KI",
    coach_personalized: "Personalisierte Analyse",
    // Agenda
    agenda_personal_planning: "Persönliche Planung",
    agenda_title: "Agenda",
    agenda_add: "+ Hinzufügen",
    agenda_event_title: "Titel",
    agenda_date: "Datum",
    agenda_category: "Kategorie",
    agenda_notes: "Notizen",
    // Vous
    vous_my_space: "Mein Bereich",
    vous_title: "Du",
    vous_agenda_tab: "Agenda",
    vous_dogs_tab: "Hunde",
    ...
    plan_long_run: "Ausfahrttag 🐕",
    plan_endurance: "Ausfahrttag 🐕",
    plan_intervals: "Ausfahrttag 🐕",
    plan_recov_note: "Deine Hunde könnten einen Ruhetag brauchen — eine Pause tut viel Gutes.",
    plan_next_km: "Wenn du Lust hast, wären etwa {n} km schön. Nur ein Vorschlag — du kennst deine Hunde am besten.",
    // Hunde-Alarme
    ...
    // Einheitstypen
    session_endurance: "Ausfahrttag 🐕", session_long: "Ausfahrttag 🐕", session_sprint: "Ausfahrttag 🐕",
    session_recup: "Ruhetag 😴", session_rest: "Ruhetag 😴", session_technique: "Ausfahrttag 🐕",
    session_endurance_desc: "Wenn ihr Lust habt",
    session_long_desc: "Wenn ihr Lust habt",
    session_sprint_desc: "Wenn ihr Lust habt",
    ...
    analytics_stats: "Stats",
    analytics_team_health: "Teamgesundheit",
    analytics_training_decision: "Trainingsentscheidung",
    analytics_dog_load: "Hundebelastung",
    analytics_last_7_days: "Letzte 7 Tage",
    analytics_alerts: "Warnungen",
    analytics_coach: "Coach",
    // Advice
    advice_health_perf: "Gesundheit & Leistung",
    advice_title: "Tipps",
    advice_important: "🚨 Wichtig",
    advice_warning_title: "Warnsignale, die man nie ignorieren sollte",
    advice_all: "📋 Alle",
    // Common
    btn_back: "Zurück",
    btn_add: "Hinzufügen",
...
function renderDogs() {
  ...
  lists.forEach(list => {
    list.innerHTML = html || `<p class="empty-state">${t('dogs_no_dogs')}</p>`;
...
function openRunDetail(index) {
  ...
  setTimeout(() => {
    ...
    if (path.length > 1) {
      ...
      const showZone = totalKm > PRIV_KM * 2.5; // assez long pour avoir une zone visible
      ...
      // Tracé en 3 segments (gris début / orange milieu / gris fin)
...
function onGPSPosition(lat, lon, accuracy, gpsSpeedMs, altitude, altitudeAccuracy, simulated, posTime) {
  ...
  if (lastPosition) {
    ...
    // Pas de filtre de distance logiciel : le plugin BackgroundGeolocation gère distanceFilter:5
    // Sur navigateur web, watchPosition envoie toutes les positions — filtrer les immobiles
...
async function startGPS() {
  ...
  elevationGain = 0;
  lastAltitude = null;
  window._altBuf = []; // réinitialiser le buffer de lissage altitude
  distance = 0;
...
async function correctElevationFromAPI(run) {
  ...
  // Échantillonner jusqu'à 100 points (limite OpenTopoData)
  const MAX = 100;
  ...
  try {
    // Pas de double-encodage : les | et , doivent rester lisibles pour OpenTopoData
    ...
    // Recalculer D+ avec les élévations terrain (seuil 2m — données propres)
    ...
    saveState();
    // Rafraîchir l'affichage si la vue détail est encore ouverte
    const elevEl = document.getElementById("rd-elev");
    if (elevEl) elevEl.textContent = run.elevationGain > 0 ? "+" + run.elevationGain + " m" : "—";
    const altEl = document.getElementById("rd-alt");
    const altWrap = document.getElementById("rd-alt-wrap");
...
// Zone de confidentialité — distance CUMULÉE RÉELLE parcourue (spec : 500m début + 500m fin)
// Retourne null si le parcours est trop court pour être anonymisé en sécurité.
// Ne modifie JAMAIS le tableau original.
function applyPrivacyZone(points, trimKm = 0.5) {
  // Travailler sur une copie sans les marqueurs de gap
  const pts = (points || []).filter(p => !p.gap && Number.isFinite(p.lat) && Number.isFinite(p.lon ?? p.lng));
  if (pts.length < 2) return null;

  // Calcul de la distance cumulée point par point
  const cumDist = [0];
  ...
  // Parcours trop court : impossible d'enlever 2×500 m sans révéler départ/arrivée
  if (totalKm < trimKm * 2.5) return null; // sécurité : refuser plutôt qu'exposer

  // Premier point dont la distance cumulée ≥ trimKm
  let startIdx = -1;
  for (let i = 0; i < pts.length; i++) {
    if (cumDist[i] >= trimKm) { startIdx = i; break; }
  }

  // Dernier point dont la distance cumulée ≤ (total - trimKm)
  let endIdx = -1;
  for (let i = pts.length - 1; i >= 0; i--) {
    if (cumDist[i] <= totalKm - trimKm) { endIdx = i; break; }
  }
...
async function shareCurrentTrail(run) {
  ...
  // Zone de confidentialité — OBLIGATOIRE, jamais contournable
...
document.getElementById("runs-view-list-btn")?.addEventListener("click", () => {
  ...
  document.querySelector("#vous-enregistrement .run-list.gps-history").style.display = "";
});
